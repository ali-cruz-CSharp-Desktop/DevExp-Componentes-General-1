...
namespace DevExpress_Componentes01 {
    ...
    public partial class AdventureWorks2012DataSet : global::System.Data.DataSet {
        ...
        public partial class AddressDataTable : global::System.Data.TypedTableBase<AddressRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public AddressRow AddAddressRow(string AddressLine1, string AddressLine2, string City, int StateProvinceID, string PostalCode, System.Guid rowguid, System.DateTime ModifiedDate) {
...
namespace DevExpress_Componentes01.AdventureWorks2012DataSetTableAdapters {
    ...
    public partial class AddressTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Person].[Address] ([AddressLine1], [AddressLine2], [City], [StateProvinceID], [PostalCode], [rowguid], [ModifiedDate]) VALUES (@AddressLine1, @AddressLine2, @City, @StateProvinceID, @PostalCode, @rowguid, @ModifiedDate);
SELECT AddressID, AddressLine1, AddressLine2, City, StateProvinceID, PostalCode, rowguid, ModifiedDate FROM Person.Address WHERE (AddressID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Person].[Address] SET [AddressLine1] = @AddressLine1, [AddressLine2] = @AddressLine2, [City] = @City, [StateProvinceID] = @StateProvinceID, [PostalCode] = @PostalCode, [rowguid] = @rowguid, [ModifiedDate] = @ModifiedDate WHERE (([AddressID] = @Original_AddressID) AND ([AddressLine1] = @Original_AddressLine1) AND ((@IsNull_AddressLine2 = 1 AND [AddressLine2] IS NULL) OR ([AddressLine2] = @Original_AddressLine2)) AND ([City] = @Original_City) AND ([StateProvinceID] = @Original_StateProvinceID) AND ([PostalCode] = @Original_PostalCode) AND ([rowguid] = @Original_rowguid) AND ([ModifiedDate] = @Original_ModifiedDate));
SELECT AddressID, AddressLine1, AddressLine2, City, StateProvinceID, PostalCode, rowguid, ModifiedDate FROM Person.Address WHERE (AddressID = @AddressID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DevExpress_Componentes01.Properties.Settings.Default.AdventureWorks2012ConnectionString;
        }
        ...
        public virtual int Fill(AdventureWorks2012DataSet.AddressDataTable dataTable) {
        ...
        public virtual AdventureWorks2012DataSet.AddressDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AdventureWorks2012DataSet.AddressDataTable dataTable = new AdventureWorks2012DataSet.AddressDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AdventureWorks2012DataSet.AddressDataTable dataTable) {
        ...
        public virtual int Insert(string AddressLine1, string AddressLine2, string City, int StateProvinceID, string PostalCode, System.Guid rowguid, System.DateTime ModifiedDate) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(Original_StateProvinceID));
            if ((Original_PostalCode == null)) {
                throw new global::System.ArgumentNullException("Original_PostalCode");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string AddressLine1, string AddressLine2, string City, int StateProvinceID, string PostalCode, System.Guid rowguid, System.DateTime ModifiedDate, int Original_AddressID, string Original_AddressLine1, string Original_AddressLine2, string Original_City, int Original_StateProvinceID, string Original_PostalCode, System.Guid Original_rowguid, System.DateTime Original_ModifiedDate) {
            return this.Update(AddressLine1, AddressLine2, City, StateProvinceID, PostalCode, rowguid, ModifiedDate, Original_AddressID, Original_AddressLine1, Original_AddressLine2, Original_City, Original_StateProvinceID, Original_PostalCode, Original_rowguid, Original_ModifiedDate, Original_AddressID);
        }
    }
